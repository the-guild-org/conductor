...
use vrl::{
    ...
    stdlib::{
        Abs, Append, Array, Assert, AssertEq, Boolean, Ceil, Chunks, Compact, Contains,
        ContainsAll, DecodeBase64, DecodePercent, Del, Downcase, EncodeBase64, EncodeJson,
        EncodePercent, EndsWith, Exists, Filter, Find, Flatten, Float, Floor, ForEach, FormatInt,
        FormatNumber, Get, GetEnvVar, GetHostname, Hmac, Includes, Integer, IsArray, IsBoolean,
        IsEmpty, IsFloat, IsInteger, IsJson, IsNull, IsNullish, IsObject, IsRegex, IsString,
        IsTimestamp, Join, Keys, Length, Log, MapKeys, MapValues, Match, MatchAny, MatchArray, Md5,
        Merge, Mod, Now, Object, ParseFloat, ParseInt, ParseJson, ParseKeyValue, ParseQueryString,
        ParseRegex, ParseRegexAll, ParseUrl, ParseUserAgent, Push, RandomBool, RandomBytes,
        RandomFloat, RandomInt, Redact, Remove, Replace, Round, Set, Slice, Split, StartsWith,
        String as VrlString, StripAnsiEscapeCodes, StripWhitespace, Strlen, Timestamp, ToBool,
        ToFloat, ToInt, ToRegex, ToString, Truncate, Unique, Unnest, Upcase, UuidV4, Values,
    },
    value,
    value::Value,
};
